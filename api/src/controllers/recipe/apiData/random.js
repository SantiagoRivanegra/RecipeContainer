...
//CUando lo ejecutaba del controller no melo tomaba como function
const randomRecipe = async() => {
  const randomRecipe = await axios.get(`https://www.themealdb.com/api/json/v1/1/random.php`)
      const random = await randomRecipe.data.meals.map(r => {
        return {
          id: r.idMeal,
